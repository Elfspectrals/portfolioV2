        ...
        return (
          <div className="p-5 bg-gray-800 rounded-lg mt-5">
            <p className="text-gray-300">
              ...
              Il y aura donc plusieurs phase de jeu : <br />
    ...
    <div className="bg-black text-white w-full h-screen flex flex-col justify-center items-center">
      <section className="mb-8 w-full max-w-screen-lg mx-auto">
        ...
        <div className="flex space-x-4">
          <div className="w-64 flex-shrink-0" onClick={() => setSelectedProject('Neo Jerome')}>
          ...
          <div className="w-64 flex-shrink-0" onClick={() => setSelectedProject('Jerome Chanel')}>
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <div>
          <h2 className="text-4xl font-bold mb-4 text-center text-indigo-400">Learn about any project [click on the image]</h2>
